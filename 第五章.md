...
事实证明，区分语言规律和编纂文化偏见是困难的。 例如，医生不是事实上的男性，护士不是事实上的女性，但这些长期存在的文化偏见被视为语言的规律性，并被编入单词向量中，如例5-6所示。
...
您需要注意嵌入中的偏见，因为它们在NLP应用程序中的受欢迎程度和使用率正在上升。 消除现有的单词嵌入偏见是一个新的令人兴奋的研究领域（参见Bolukbasi等，2016）。 此外，我们建议您访问ethicsinnlp.org，了解论理与NLP交叉的最新结果。
